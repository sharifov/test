...
use src\widgets\DateRangePicker;
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 profile_details">
            <div class="well profile_view">
                <div class="col-sm-12">
                    <h4 class="brief" style="margin-bottom:20px;"><i>Trip</i></h4>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <?= $form->field($model, 'departRangeTime', ['options' => ['class' => 'form-group']])->widget(DateRangePicker::class, [
                ...
                <div class="profile-bottom text-center" style="padding: 15px 0">
                </div>
            </div>
        </div>
    </div>

...
use sales\model\call\entity\callCommand\types\Refer;
...
?>
    ...
    <?php $formType = ActiveForm::begin($callCommandTypeService::configActiveForm($formId, $typeId)); ?>
        ...
        <div class="row">
            <div class="col-md-4">
                <?php echo $formType->field($model, 'sip')->textInput(['maxlength' => true])  ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <?php echo $formType->field($model, 'method')->dropDownList(Refer::METHOD_LIST) ?>
            </div>
        </div>

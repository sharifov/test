...
namespace src\model\user\entity\payment;

use common\models\Employee;
use common\models\query\EmployeeQuery;
use src\model\user\entity\paymentCategory\UserPaymentCategory;
use src\model\user\entity\paymentCategory\UserPaymentCategoryQuery;
use src\model\user\entity\payroll\UserPayroll;
use src\model\user\entity\payroll\UserPayrollQuery;

            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="margin: 0">
                    ...
                    <?php foreach ($departments as $department) : ?>
                        ...
                        ?>
                        <tr>
                            <td class="text-right"><span><?= $n++ ?>.</span></td>

                            <td><?= $department->dppProject ? Html::encode($department->dppProject->name) : '' ?></td>
                            <td>
                                <b><?= $department->dppDep ? (Html::encode($department->dppDep->dep_name)) : '' ?></b>
                                <a href="javascript:void(0)" title="User Online: <?= $countAgents ?>"><?= ' (' . $countAgents . ')' ?></a>
                            </td>
                            <td>
                                <?php
                                $userGroupList = [];
                            ...
                            <?php //=Html::encode($department->dpp_phone_number) ?><!--</td>-->

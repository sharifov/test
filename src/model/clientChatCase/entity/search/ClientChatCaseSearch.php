...
namespace src\model\clientChatCase\entity\search;
...
class ClientChatCaseSearch extends ClientChatCase
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->cccs_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'cccs_created_dt', $this->cccs_created_dt, $user->timezone);
        }

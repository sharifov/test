...
$this->title                   = 'Clone to Role: "' . $model->name . '"';
    ...
    <div class="abac-policy-form">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    <div class="col-md-6">
                        <?= Html::label('Choose Role to clone from', 'role_donor', ['class' => 'control-label']) ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?= Html::submitButton('<i class="fa fa-save"></i> Clone item', ['class' => 'btn btn-success', 'id' => 'btn-submit']) ?>
                </div>
            </div>
        </div>
        <div class="row">

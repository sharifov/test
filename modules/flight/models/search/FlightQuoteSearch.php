...
class FlightQuoteSearch extends FlightQuote
{
    ...
    public function rules()
    {
        return [
            ...
            [['fq_hash_key', 'fq_record_locator', 'fq_gds', 'fq_gds_pcc', 'fq_cabin_class', 'fq_main_airline', 'fq_created_expert_name', 'fq_reservation_dump', 'fq_pricing_info', 'fq_origin_search_data', 'fq_last_ticket_date'], 'safe'],

...
class m220420_144302_update_abac_rules_refund_and_change extends Migration
{
    ...
    public function safeUp(): void
    {
        ...
        $this->insert(
            ...
            [
                'ap_rule_type' => 'p',
                'ap_subject' => '((("admin" in r.sub.env.user.roles) || ("support_senior" in r.sub.env.user.roles)) || ((isOrderOwner == true) && (("ex_agent" in r.sub.env.user.roles) || ("ex_super" in r.sub.env.user.roles) || ("exchange_senior" in r.sub.env.user.roles) || ("schd_agent" in r.sub.env.user.roles) || ("schd_super" in r.sub.env.user.roles)))) && (isPqChangeable == true) && (hasPqrActive == false) && (hasPqcAccepted == false)',
        ...
        $this->insert(
            ...
            [
                'ap_rule_type' => 'p',
                'ap_subject' => '((("admin" in r.sub.env.user.roles) || ("support_senior" in r.sub.env.user.roles)) || ((isOrderOwner == true) && (("ex_agent" in r.sub.env.user.roles) || ("ex_super" in r.sub.env.user.roles) || ("exchange_senior" in r.sub.env.user.roles) || ("schd_agent" in r.sub.env.user.roles) || ("schd_super" in r.sub.env.user.roles)))) && (isPqChangeable == true) && (hasPqcActive == false) && (hasPqrAccepted == false)',

...
namespace src\model\kpi\entity\kpiUserPerformance\search;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use src\model\kpi\entity\kpiUserPerformance\KpiUserPerformance;

/**
 * KpiUserPerformanceSearch represents the model behind the search form of `src\model\kpi\entity\KpiUserPerformance`.
 */

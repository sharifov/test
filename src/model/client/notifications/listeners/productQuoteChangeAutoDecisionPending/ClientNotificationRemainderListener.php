...
/**
 * Class ClientNotificationRemainderListener
 *
...
class ClientNotificationRemainderListener
{
    ...
    public function handle(ProductQuoteChangeClientRemainderNotificationEvent $event): void
    {
        try {
            ...
            \Yii::warning([
                ...
                'event' => [
                    'name' => ProductQuoteChangeClientRemainderNotificationEvent::class,
                    'productQuoteChangeId' => $event->productQuoteChangeId,
                ],
                'exception' => AppHelper::throwableLog($e, true),
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:OverdueException');
        } catch (\Throwable $e) {
            \Yii::error([
                'message' => $e->getMessage(),
                'event' => [
                ...
                'exception' => AppHelper::throwableLog($e, true),
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:handle');
        }
    }
    ...
    private function phoneNotificationProcessing(
        ...
        if (!$phoneFromId) {
            ...
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:phoneNotificationProcessing');
            return;
        }
    ...
    private function smsNotificationProcessing(
        ...
        if (!$settings->messageTemplateKey) {
            \Yii::error([
                ...
                'caseId' => $productQuoteChange->pqc_case_id,
                'phone' => $settings->phoneFrom,
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:smsNotificationProcessing');
            return;
        }
    ...
    private function emailNotificationProcessing(
        ...
        if (!$settings->messageTemplateKey) {
            ...
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:emailNotificationProcessing');
            return;
        }
        $templateKey = $settings->messageTemplateKey;
    ...
    private function getClient(ProductQuoteChange $productQuoteChange): Client
    {
        ...
        if (!$clientPhoneId) {
            \Yii::error([
                ...
                'productQuoteChangeId' => $productQuoteChange->pqc_id,
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:getClient');
    ...
    private function addClientPhone(int $clientId, string $phone): ?int
    {
        try {
            ...
            \Yii::error([
                ...
                'clientId' => $clientId,
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:addClientPhone');
        } catch (\Throwable $e) {
            \Yii::error([
    ...
    private function addClientEmail(int $clientId, string $email): ?int
    {
        try {
            ...
            \Yii::error([
                ...
                'clientId' => $clientId,
            ], 'ProductQuoteChangeAutoDecisionPendingClientNotificationRemainderListener:addClientEmail');
        } catch (\Throwable $e) {
            \Yii::error([

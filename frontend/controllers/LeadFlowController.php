...
class LeadFlowController extends FController
{
    ...
    /**
     * Lists all LeadFlow models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new LeadFlowSearch();
    ...
    /**
     * Displays a single LeadFlow model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing LeadFlow model.
    ...
    /**
     * Deletes an existing LeadFlow model.
    ...
    /**
     * Finds the LeadFlow model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LeadFlow the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LeadFlow::findOne($id)) !== null) {
            return $model;
        }

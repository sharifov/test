        ...
        <div class="table-wrapper table-responsive ticket-details-block__table mb-20">
            ...
            <div class="row" style="margin: 0 0 20px;">
                <div class="col-md-6 form-inline">
                    <?= $form->field($lead->getAdditionalInformationFormFirstElement(), 'pnr')->textInput()->label('Add PNR:&nbsp;') ?>
            ...
            <table class="table table-striped table-neutral">
                ...
                <tbody>
                <?php
                foreach ($lead->getAdditionalInformationFormFirstElement()->paxInfo as $index => $passenger) : ?>
                    <tr>
                        <td class="td-input">
                            <?= $passenger['pax'] ?>
                        </td>

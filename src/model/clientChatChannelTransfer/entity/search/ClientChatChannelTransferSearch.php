...
namespace src\model\clientChatChannelTransfer\entity\search;

use common\models\Employee;
use common\models\Project;
use src\model\clientChatChannel\entity\ClientChatChannel;
use yii\data\ActiveDataProvider;
use src\model\clientChatChannelTransfer\entity\ClientChatChannelTransfer;
use yii\helpers\ArrayHelper;

/**
 * Class ClientChatChannelTransferSearch
 * @package src\model\clientChatChannelTransfer\entity\search
 *
...
class ClientChatChannelTransferSearch extends ClientChatChannelTransfer
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->cctr_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'cctr_created_dt', $this->cctr_created_dt, $user->timezone);
        }

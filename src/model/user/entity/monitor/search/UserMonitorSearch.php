...
namespace src\model\user\entity\monitor\search;
...
/**
 * UserMonitorSearch represents the model behind the search form of `src\model\user\entity\monitor\UserMonitor`.
 */

...
/**
 * Class m220712_083319_add_abac_permission_for_business_extra_queue_access
 */
class m220712_083319_add_abac_permission_for_business_extra_queue_access extends Migration
{
    ...
    public function safeUp()
    {
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_title' => 'Access to view business extra queue page',

...
/**
 * Class m190924_132536_add_permission_check_user_call
 */
class m190924_132536_add_permission_check_user_call extends Migration
{
    public $routes = [
        '/phone/ajax-check-user-for-call'
    ];

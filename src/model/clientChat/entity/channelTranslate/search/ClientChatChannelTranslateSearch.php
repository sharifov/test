...
namespace src\model\clientChat\entity\channelTranslate\search;
...
/**
 * ClientChatChannelTranslateSearch represents the model behind the search form of `src\model\clientChat\entity\channelTranslate\ClientChatChannelTranslate`.
 */

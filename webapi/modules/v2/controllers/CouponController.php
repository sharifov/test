...
use src\model\coupon\entity\coupon\repository\CouponRepository;
use src\model\coupon\entity\coupon\serializer\CouponSerializer;
use src\model\coupon\entity\coupon\service\CouponService;
use src\model\coupon\entity\couponProduct\CouponProduct;
use src\model\coupon\entity\couponProduct\repository\CouponProductRepository;
use src\model\coupon\entity\couponUse\CouponUse;
use src\model\coupon\entity\couponUse\repository\CouponUseRepository;
...
use src\model\coupon\useCase\apiCreate\CouponApiCreateService;
use src\model\coupon\useCase\apiCreate\CouponCreateForm;
use src\model\coupon\useCase\apiEdit\CouponApiEditService;
use src\model\coupon\useCase\apiEdit\CouponEditForm;
use src\model\coupon\useCase\apiInfo\CouponInfoForm;
use src\model\coupon\useCase\apiUse\CouponUseForm;
use src\model\coupon\useCase\apiValidate\CouponValidateForm;

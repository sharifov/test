...
<h1>
    <i class="fa fa-flag text-success"></i> <?= Html::encode($this->title) ?>
</h1>

<div class="orders-q-complete">
    <?php Pjax::begin(['id' => 'orders-q-complete-pjax-list', 'timeout' => 5000, 'enablePushState' => true, 'scrollTo' => 0]); ?>

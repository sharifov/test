...
namespace sales\model\userStatDay\entity\search;
...
/**
 * UserStatDaySearch represents the model behind the search form of `sales\model\userStatDay\entity\UserStatDay`.
 */

...
class FlightSegmentRepository
{
    ...
    public function find($id): FlightSegment
    {
        ...
        throw new NotFoundException('FlightSegment is not found.', AttractionCodeException::SEGMENT_NOT_FOUND);
    }
    ...
    public function save(FlightSegment $segment): int
    {
        if (!$segment->save(false)) {
            throw new \RuntimeException('Saving error.', AttractionCodeException::SEGMENT_SAVE);
        }
    ...
    {
        if (!$segment->delete()) {
            throw new \RuntimeException('Removing error.', AttractionCodeException::SEGMENT_REMOVE);
        }
        $this->eventDispatcher->dispatchAll($segment->releaseEvents());
    }

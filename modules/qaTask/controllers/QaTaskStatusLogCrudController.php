...
class QaTaskStatusLogCrudController extends FController
{
    ...
    {
        $searchModel = new QaTaskStatusLogCrudSearch();
    ...
    {
        $model = new QaTaskStatusLog();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->tsl_id]);
        }
    ...
    /**
     * @param $id
     * @return QaTaskStatusLog
     * @throws NotFoundHttpException
     */
    protected function findModel($id): QaTaskStatusLog
    {
        if (($model = QaTaskStatusLog::findOne($id)) !== null) {
            return $model;
        }

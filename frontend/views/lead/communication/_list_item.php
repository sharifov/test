        ...
        if ($chat = ClientChat::find()->andWhere(['cch_id' => $model['id']])->with(['feedback'])->one()) {
            ...
            <div class="chat__message chat__message--client chat__message--phone">
                ...
                <div class="chat__message-heading">
                    ...
                    <div class="chat__date">
                        Id: <u title="RID: <?= $chat->cch_rid?>"> <a href="/call/view?id=3363432" target="_blank" data-pjax="0"><?= $chat->cch_id ?></a></u>
                    ...
                    <table class="table table-condensed" style="background-color: rgba(255, 255,255, .7)">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success btn-xs btn-recording_url" ><?= $duration ?> </button>
                                </td>

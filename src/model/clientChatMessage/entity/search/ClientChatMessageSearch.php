...
namespace src\model\clientChatMessage\entity\search;
...
/**
 * ClientChatMessageSearch represents the model behind the search form of `src\model\clientChatMessage\entity\ClientChatMessage`.
 */

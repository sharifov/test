...
<div class="calls-search">
    ...
    <dinv class="row">
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'c_created_user_id')->dropDownList(Employee::getActiveUsersListFromCommonGroups(Auth::id()), ['prompt' => '-'])->label('Username') ?>
                </div>
                <div class="col-md-6">
                    <?= $form->field($model, 'callDepId')->dropDownList(EmployeeDepartmentAccess::getDepartments(Auth::id(), null), ['prompt' => '-'])->label('Department') ?>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'c_project_id')->dropDownList(EmployeeProjectAccess::getProjects(Auth::id(), null), ['prompt' => '-'])->label('Project') ?>
                </div>
                <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group text-center">
                ...
                <?= Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset form', ['stats/calls-stats'], ['class' => 'btn btn-warning']) ?>
            </div>
        </div>
    </div>

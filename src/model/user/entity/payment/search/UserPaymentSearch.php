...
namespace src\model\user\entity\payment\search;
...
/**
 * UserPaymentSearch represents the model behind the search form of `src\model\user\entity\payment\UserPayment`.
 */

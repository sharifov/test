    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'label' => 'Recording',
                'value' => static function (\common\models\Conference $model) {
                    return  $model->cf_recording_duration ? Html::button(gmdate('i:s', $model->cf_recording_duration) . ' <i class="fa fa-volume-up"></i>', ['class' => 'btn btn-' . ($model->cf_recording_duration < 30 ? 'warning' : 'success') . ' btn-xs btn-recording_url', 'data-source_src' => yii\helpers\Url::to(['call/record', 'sid' =>  $model->cf_sid, 'cfRecord' => true ]) ]) : '-';
                },
                'format' => 'raw',

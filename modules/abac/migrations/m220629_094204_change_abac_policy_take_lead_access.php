...
{
    private const AP_SUBJECT = '((((r.sub.status_id == 14) && (r.sub.canTakeByFrequencyMinutes == false)) || ((r.sub.status_id == 1) && ((r.sub.withinPersonalTakeLimits == false) || (r.sub.canTakeByFrequencyMinutes == false))) || ((r.sub.status_id == 15) && (r.sub.canTakeByFrequencyMinutes == true))) && (("agent" in r.sub.env.user.roles) || ("fb_agent" in r.sub.env.user.roles))) || (r.sub.status_id == 4) || (r.sub.status_id == 10) || (r.sub.status_id == 12)';

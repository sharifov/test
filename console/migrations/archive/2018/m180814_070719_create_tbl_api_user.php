...
class m180814_070719_create_tbl_api_user extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $projects = [];
        $projects[] = ['id' => 1, 'name' => 'HOP2', 'api_username' => 'hop2', 'api_password' => '54d120d9d4e6489443ae33f9e08fefe3c1006dfdedf1574ae97d0589154a8250', 'email' => 'no-reply@hop2.com', 'project_id' => null];
        $projects[] = ['id' => 2, 'name' => 'OVAGO', 'api_username' => 'ovago', 'api_password' => '038ce0121a1666678d4db57cb10e8667b98d8b08c408cdf7c9b04f1430071826', 'email' => 'no-reply@ovago.com', 'project_id' => null];
        $projects[] = ['id' => 3, 'name' => 'WEFARE', 'api_username' => 'wefare', 'api_password' => 'dc83bdfb8b66644215c38eed04c47c2aa0ca5bd409a801b30b0c4d5d54bbb1b2', 'email' => 'assistant@wefare.com', 'project_id' => null];
        $projects[] = ['id' => 4, 'name' => 'GURUFARE', 'api_username' => 'gurufare', 'api_password' => '2a1dd61a3baf61b22241de93d1d4c072f44391de407d7c26cecb98b50012e492', 'email' => null, 'project_id' => null];
        $projects[] = ['id' => 5, 'name' => 'BUSINESSCLASS', 'api_username' => 'businessclass', 'api_password' => '57966012c9d9d871a7f3ef26a727fd06ca1a8cc06a51afb7adbdd4afc3f25c3e', 'email' => null, 'project_id' => null];
        $projects[] = ['id' => 6, 'name' => 'WOWFARE', 'api_username' => 'wowfare', 'api_password' => 'd190c378e131ccfd8a889c8ee8994cb55f22fbeeb93f9b99007e8e7ecc24d0dd', 'email' => 'assistant@wowfare.com', 'project_id' => null];

...
<div class="row">
    <div class="col-md-12">
        <?php $form = ActiveForm::begin([
                ...
                'action' => \yii\helpers\Url::toRoute(['/client-chat-flight-quote/ajax-search-quotes-by-chat',
                    'chat_id' => $viewModel->chatId,
                    'lead_id' => $viewModel->lead->id,
                ])
        ]) ?>
              ...
              <div class="form-group">
                ...
                <script>
                    ...
                    sliderDuration.noUiSlider.on('update', function (values, handle) {
                        ...
                        $('#search-quote-price-filter').closest('.form-group').find('#search-quote-price-value').html(currencySymbol+' '+values[handle]);
                    });
                </script>
              </div>
            </div>

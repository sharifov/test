...
namespace src\model\sms\entity\smsDistributionList\search;
...
/**
 * SmsDistributionListSearch represents the model behind the search form of `src\model\sms\entity\smsDistributionList\SmsDistributionList`.
 */

    ...
    <div class="col-sm-12">
        <div class="request">
            <div class="request-overview" style="">
                <div style="letter-spacing: 0.8px; border-bottom: 1px dotted rgb(165, 177, 197); padding-bottom: 13px;" class="row-flex row-flex-justify">
                    ...
                    <div class="request-form collapse in" id="request" aria-expanded="true">
                        ...
                        <div class="sl-itinerary-form2">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-1">
                                    <?= $form->field($itineraryForm, 'adults')->dropDownList(array_combine(range(0, 9), range(0, 9)), ['prompt' => '-']) ?>
                                </div>
                                <div class="col-sm-1">
                                    <?= $form->field($itineraryForm, 'children')->dropDownList(array_combine(range(0, 9), range(0, 9)), ['prompt' => '-']) ?>
                                </div>
                                <div class="col-sm-1">
                                    <?= $form->field($itineraryForm, 'infants')->dropDownList(array_combine(range(0, 9), range(0, 9)), ['prompt' => '-']) ?>
                                </div>

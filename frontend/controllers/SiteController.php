...
class SiteController extends DefaultController
{
    ...
    public function dashboardSupervision() : string
    {
        ...
        return $this->render('index_supervision', ['dataStats' => $dataStats, 'dataSources' => $dataSources, 'dataEmployee' => $dataEmployee, 'dataEmployeeSold' => $dataEmployeeSold, 'days2' => $days2,
            //'myTaskByDate' => $myTaskByDate,
            'searchModel' => $searchModel,
            'dp1' => $dp1,
            'dp2' => $dp2,

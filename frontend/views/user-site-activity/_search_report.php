...
/* @var $model frontend\models\search\UserSiteActivitySearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="user-site-activity-search-report">
    <div class="x_panel">
        <div class="x_title">
...
<!---->
            <div class="col-md-2">
                <?= $form->field($model, 'usa_user_id')->dropDownList(\common\models\Employee::getList(), ['prompt' => '-']) ?>
            </div>
<!---->
<!--            <div class="col-md-2">-->

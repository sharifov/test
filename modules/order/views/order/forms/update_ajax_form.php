...
<div class="order-form">
    ...
    $form = ActiveForm::begin([
        ...
        'action' => ['/order/order/update-ajax', 'id' => $model->or_id],
        'method' => 'post'
    ]);
    ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <?= $form->field($model, 'or_status_id')->dropDownList(\modules\order\src\entities\order\OrderStatus::getList(), ['prompt' => '---']) ?>
        </div>
        <div class="col-md-6">
            <?= $form->field($model, 'or_pay_status_id')->dropDownList(\modules\order\src\entities\order\OrderPayStatus::getList(), ['prompt' => '---']) ?>
        </div>
    </div>

 ...
 * @property int|int $prevChannelId
 */
class ClientChatManageStatusLogEvent
{
	public $chat;
	...
	public function __construct(ClientChat $chat, ?int $oldStatus, int $newStatus, ?int $ownerId, ?int $creatorUserId, ?string $description, ?int $prevChannelId)
	{
		$this->chat = $chat;

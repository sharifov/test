...
/**
 * Class ContactPhoneListCrudController
 */
class ContactPhoneListCrudController extends FController
{
    ...
    {
        $model = new ContactPhoneList();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->cpl_id]);
        }

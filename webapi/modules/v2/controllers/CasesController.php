...
class CasesController extends BaseController
{
    ...
    public function actionCreate(): Response
    {
        ...
        if (
            ...
            ExperimentTarget::saveExperimentList(ExperimentTarget::EXT_TYPE_CASE, $case->cs_id, $form->experiments);
        ...
        ExperimentTarget::saveExperimentList(ExperimentTarget::EXT_TYPE_CASE, $result->csId, $form->experiments);

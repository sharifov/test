...
class VoluntaryChangeQuotePreviewEmailForm extends \yii\base\Model
{
    public $case_id;
    ...
    {
        return [
            [['case_id', 'email_from', 'email_to', 'email_message', 'email_subject', 'changeId', 'originQuoteId'], 'required'],
            [['email_subject', 'email_message'], 'trim'],
            [['email_to', 'email_from'], 'email'],
            [['email_tpl_id', 'case_id', 'changeId', 'originQuoteId'], 'integer'],

...
$this->title = 'Pass Departure Queue';
...
<div class="cases-q-pass-departure">
    <?php Pjax::begin(['id' => 'cases-q-pass-departure-pjax-list', 'timeout' => 5000, 'enablePushState' => true, 'scrollTo' => 0]); ?>

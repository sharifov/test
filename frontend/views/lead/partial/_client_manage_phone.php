...
<? Pjax::begin(['id' => 'pjax-client-manage-phone', 'enablePushState' => false, 'enableReplaceState' => false]) ?>
...
<? foreach ($clientPhones as $key => $phone): ?>
    <table class="table table-condensed">
        <tr>
            ...
            <td><i class="fa fa-phone"></i> <?= $phone->phone ?></td>
            <td class="text-right showModalButton" title="Edit Phone" data-content-url="<?= Url::to(['lead-view/ajax-edit-client-phone-modal-content', 'gid' => $lead->gid, 'pid' => $phone->id]) ?>" data-modal_id="client-manage-info"><i class="fa fa-edit" style="cursor:pointer;"></i></td>
        </tr>
    </table>
<? endforeach; ?>

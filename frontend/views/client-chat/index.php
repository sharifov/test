    ...
    <?= GridView::widget([
        ...
        'columns' => [
                ...
                'value' => static function (ClientChat $model) {
                    return $model->cch_parent_id ?
                        Html::a(
                            ...
                            ['client-chat/detail', 'id' => $model->cch_parent_id],
            ...
            [
                ...
                'value' => static function (ClientChat $model) {
                    ...
                    return Html::a(
                        ...
                        ['/client-chat/detail', 'id' => $model->cch_id, '#' => 'messages'],
                        [
                            'target' => '_blank',
                            'data-pjax' => 0,
                            'title' => 'Messages',
            ...
            [
                ...
                'template' => '{detail}<br />{room}',
                'contentOptions' => ['style' => 'width:50px; white-space: normal;'],
                'buttons' => [
                    'detail' => static function ($url, ClientChat $model) {
                        return Html::a(

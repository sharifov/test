            ...
            <div class="x_content" style="display: block;">
                <div class="col-md-3 col-sm-3  profile_left">
                    ...
                    <ul class="list-unstyled user_data">
                        ...
                        <li>
                            <i class="fa fa-briefcase user-profile-icon"></i> Role: <?= $roles ? \yii\bootstrap4\Html::encode(implode(', ', $roles)) : '-' ?>
                        </li>
                        <li>
                            <i class="fa fa-user user-profile-icon"></i> Full Name: <?= Html::encode($model->full_name) ?>
                        </li>
                        <li>
                            <i class="fa fa-user user-profile-icon"></i> Nickname Client Chat: <?= Html::encode($model->nickname_client_chat) ?>
                        </li>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                <?= $this->render('partial/_info_project', [
                                    'model' => $model,
                                ]) ?>
                            </div>

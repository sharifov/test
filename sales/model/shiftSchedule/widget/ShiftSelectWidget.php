...
namespace sales\model\shiftSchedule\widget;
...
class ShiftSelectWidget extends \kartik\select2\Select2
{
    ...
    public function init(): void
    {
        ...
        $this->url = $this->url ?: Url::to(['/shift-crud/ajax-list']);
...
JS;
        $this->getView()->registerJs($js, View::POS_HEAD, 'shift');
    }
}

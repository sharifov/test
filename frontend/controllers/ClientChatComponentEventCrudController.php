...
class ClientChatComponentEventCrudController extends FController
{
    ...
    {
        $model = new ClientChatComponentEvent();
     ...
     * @throws NotFoundHttpException
     */
    protected function findModel($id): ClientChatComponentEvent
    {
        if (($model = ClientChatComponentEvent::findOne($id)) !== null) {
            return $model;
        }

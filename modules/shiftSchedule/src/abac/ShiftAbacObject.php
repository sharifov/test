...
class ShiftAbacObject extends AbacBaseModel implements AbacInterface
{
    ...
    public const ACT_SUMMARY_REPORT = self::NS . 'act/summary_report';
    ...
    public const OBJECT_LIST = [
        ...
        self::ACT_SUMMARY_REPORT => self::ACT_SUMMARY_REPORT,
    ];
    ...
    public const ACTION_SOFT_DELETE = 'softDelete';
    ...
    public const ACTION_REMOVE_FUTURE_USER_SCHEDULE = 'removeFutureUserSchedule';
    ...
    public const OBJECT_ACTION_LIST = [
        ...
        self::ACT_USER_SHIFT_SCHEDULE => [
            self::ACTION_ACCESS,
            self::ACTION_REMOVE_FUTURE_USER_SCHEDULE,
            ],

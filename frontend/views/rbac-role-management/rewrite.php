...
$this->title                   = 'Rewrite to Role: "' . $model->name . '"';
$this->params['breadcrumbs'][] = ['label' => 'Rbac Role Management', 'url' => ['index']];
$this->params['breadcrumbs'][] = 'Rewrite';
?>
    ...
    <div class="abac-policy-form">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="row">
                    <div class="col-md-6">
                        <?= Html::label('Choose Role to Rewrite from', 'role_donor', ['class' => 'control-label']) ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?= Html::submitButton('<i class="fa fa-save"></i> Rewrite item', ['class' => 'btn btn-success', 'id' => 'btn-submit']) ?>
                </div>
            </div>
        </div>
        <div class="row">

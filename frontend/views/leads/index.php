...
?>
    ...
    $showFilter = $accessSimpleSearch ? false : true;
...
//                }
        ...
        [
            ...
            'visible' => (!$accessSimpleSearch && $searchModel->show_fields && in_array('check_list', $searchModel->show_fields, true)),
        ],
        [
            'header' => 'Quotes',
            'value' => static function (Lead $model) use ($accessSimpleSearch) {
        ...
        [
            ...
            'visible' => (!$accessSimpleSearch && $searchModel->show_fields && in_array('expert_quotes', $searchModel->show_fields, true)),
        ],
        [
            'header' => 'Segments',
            'value' => static function (Lead $model) {
        ...
        [
            ...
            'filter' => $accessSimpleSearch ? '' : true,
            'id' => 'employee-filter',
            'options' => ['width' => '200px'],

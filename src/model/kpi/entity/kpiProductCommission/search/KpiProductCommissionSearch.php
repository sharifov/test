...
namespace src\model\kpi\entity\kpiProductCommission\search;
...
/**
 * KpiProductCommissionSearch represents the model behind the search form of `src\model\kpi\entity\kpiProductCommission\KpiProductCommission`.
 */

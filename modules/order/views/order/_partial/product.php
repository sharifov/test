                ...
                <div class="x_panel">
                    ...
                    <div class="x_content" style="display: block">
                        <?php foreach ($orderRelatedQuotes as $productQuote) : ?>
                            ...
                            <?php if ($productQuote->isRentCar() && $productQuote->pq_product_id == $product->pr_id) :?>
                            ...
                            <?php if ($productQuote->isAttraction() && $productQuote->pq_product_id == $product->pr_id) :?>
                                <?php $attractionProductQuotes[] = $productQuote; ?>
                            <?php endif; ?>
                        ...
                        <?php if ($product->isRenTCar()) :?>
                            <?= $this->render('product_rentcar_quotes', [
                                'data' => $rentCarProductQuotes,
                                'productId' => $product->pr_id
                            ]) ?>
                        <?php endif; ?>
                        ...
                        <?php if ($product->isAttraction()) :?>
                            <?= $this->render('product_attraction_quotes', [
                                'data' => $attractionProductQuotes,
                                'productId' => $product->pr_id
                            ]) ?>
                        <?php endif; ?>
                    </div>

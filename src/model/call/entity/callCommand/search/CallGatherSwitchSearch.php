...
namespace src\model\call\entity\callCommand\search;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use src\model\call\entity\callCommand\CallGatherSwitch;

/**
 * CallGatherSwitchSearch represents the model behind the search form of `src\model\call\entity\callCommand\CallGatherSwitch`.
 */

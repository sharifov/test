...
/**
 * Class m220429_065150_correct_update_abac_rules_refund_and_change
 */
class m220429_065150_correct_update_abac_rules_refund_and_change extends Migration
{
    ...
    public function safeDown(): void
    {
        ...
        $this->insert(
            ...
            [
                'ap_rule_type' => 'p',
                'ap_subject' => '(("admin" in r.sub.env.user.roles) || ("support_senior" in r.sub.env.user.roles) || ((r.sub.isCaseOwner == true) && (("ex_agent" in r.sub.env.user.roles) || ("exchange_agent_with_inbox" in r.sub.env.user.roles))) || ("schd_super" in r.sub.env.user.roles) || ((r.sub.isCaseOwner == true) && ("schd_agent" in r.sub.env.user.roles)) || (("ex_super" in r.sub.env.user.roles))) && (r.sub.pqrStatusId == 1) && (r.sub.hasPqrActive == false) && (r.sub.hasPqcActive == false)',
        ...
        $this->insert(
            ...
            [
                'ap_rule_type' => 'p',
                'ap_subject' => '(("admin" in r.sub.env.user.roles) && ("support_senior" in r.sub.env.user.roles) && ((r.sub.isOrderOwner == true) && (("ex_agent" in r.sub.env.user.roles) || ("ex_super" in r.sub.env.user.roles) || ("exchange_agent_with_inbox" in r.sub.env.user.roles) || ("schd_super" in r.sub.env.user.roles) || ("schd_agent" in r.sub.env.user.roles)))) || (r.sub.hasPqcInvoluntaryActive == true) || (r.sub.pqStatusId == 5) || (r.sub.pqStatusId == 6)',
                'ap_subject_json' => '{"condition":"OR","rules":[{"condition":"AND","rules":[{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"admin"},{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"support_senior"},{"condition":"AND","rules":[{"id":"product/product-quote/isOrderOwner","field":"isOrderOwner","type":"boolean","input":"radio","operator":"==","value":true},{"condition":"OR","rules":[{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"ex_agent"},{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"ex_super"},{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"exchange_agent_with_inbox"},{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"schd_super"},{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"schd_agent"}]}]}]},{"id":"product/product-quote/hasPqcInvoluntaryActive","field":"hasPqcInvoluntaryActive","type":"boolean","input":"radio","operator":"==","value":true},{"id":"product/product-quote/pqStatusId","field":"pqStatusId","type":"integer","input":"select","operator":"==","value":5},{"id":"product/product-quote/pqStatusId","field":"pqStatusId","type":"integer","input":"select","operator":"==","value":6}],"valid":true}',
                'ap_object' => 'product/product-quote/obj/product-quote',
        ...
        $this->delete(
            ...
            [
                ...
                [
                    ...
                    [
                        '(createChange)',
                        '(createVoluntaryRefundQuote)',
                        '(createChange)|(createVoluntaryRefundQuote)',
                    ]
                ],
            ]
        );

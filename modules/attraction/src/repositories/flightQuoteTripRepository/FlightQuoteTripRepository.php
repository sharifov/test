...
class FlightQuoteTripRepository
{
    public function find(int $id): FlightQuoteTrip
    {
        ...
        throw new NotFoundException('Flight Quote Trip is not found', AttractionCodeException::FLIGHT_QUOTE_TRIP_NOT_FOUND);
    }
    ...
    {
        if (!$trip->delete()) {
            throw new \RuntimeException('Removing error', AttractionCodeException::FLIGHT_QUOTE_TRIP_REMOVE);
        }
    }
}

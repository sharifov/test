...
$pjaxRefreshUrl = \yii\helpers\Url::toRoute(['/client-chat-flight-quote/ajax-search-quotes-by-chat', 'chat_id' => $chatId, 'lead_id' => $itineraryForm->leadId])
...
<?php Pjax::begin(['timeout' => 5000, 'enablePushState' => false, 'enableReplaceState' => false, 'scrollTo' => false, 'id' => 'pjax-search-quote-request']); ?>
            ...
            <div class="request-overview" style="">
                ...
                <div class="request-overview__table-wrap">
                    ...
                    <?php /*= Html::a('<i class="fa fa-edit"></i> Edit',
                        ['/client-chat-flight-quote/view-edit-form'],
                        ...
                        <?php if (Yii::$app->user->can('updateLead', ['leadId' => $itineraryForm->leadId])) : ?>
                            <div class="btn-wrapper text-right">
                                <?= Html::a(
                                    ...
                                    ['/client-chat-flight-quote/view-edit-form', 'id' => $itineraryForm->leadId, 'chat_id' => $chatId],
                                    ['class' => 'btn btn-default']
                                ) ?>
                            <?php echo Html::a('<i class="fas fa-search"> </i> Search Quotes', null, [
                                'class' => 'search_quotes btn btn-info',
                                'title' => 'Search Quotes',
                                'data-link' => \yii\helpers\Url::to(['/client-chat-flight-quote/ajax-search-quotes-by-chat', 'chat_id' => $chatId, 'lead_id' => $itineraryForm->leadId]),
                            ]) ?>
                            </div>
                        <?php endif; ?>
...
JS;
                        ...
                        <div class="sl-itinerary-form2">
                            <?php $form = ActiveForm::begin([
                                'action' => ['/client-chat-flight-quote/edit'],
                                'enableClientValidation' => false,
                                'enableAjaxValidation' => true,
                                'validationUrl' => ['/client-chat-flight-quote/validate'],
                                'id' => $itineraryFormId,
                                'options' => [
                                    'data-pjax' => 1
                                ]
                            ...
                            <?= Html::hiddenInput('chat_id', $chatId) ?>
                            ...
                            <div class="btn-wrapper text-right">
                                ...
                                <?= Html::a('<i class="fa fa-remove"></i> Close', ['/client-chat-flight-quote/view-edit-form', 'id' => $itineraryForm->leadId, 'mode' => 'view', 'chat_id' => $chatId], [
                                    'class' => 'btn btn-default',
                                ]) ?>
...
<?php
if (isset($refreshQuoteSearchResultPjax) && $refreshQuoteSearchResultPjax) {
    $js = <<<JS
  $('#pjax-search-quote-filter').html('');
JS;
    $this->registerJs($js);
}
?>

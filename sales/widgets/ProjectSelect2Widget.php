...
class ProjectSelect2Widget extends Select2
{
	private const SELECTION_NAME = 'name';
	private const SELECTION_ID = 'id';
	...
	public function init(): void
	{
		...
		$this->url = $this->url ?: Url::to(['/project/list-ajax']);
...
JS;
		$this->getView()->registerJs($js, View::POS_HEAD, '/project/list-ajax');
	}

...
class m211022_120610_access_lead_actions_take_and_take_over_abac_rules extends Migration
{
    ...
    public function safeUp()
    {
        $this->insert('{{%abac_policy}}', [
            'ap_rule_type' => 'p',
            'ap_subject' => '((r.sub.status_id == 16) || (r.sub.status_id == 1) || (r.sub.status_id == 5) || (r.sub.status_id == 8)) && ((r.sub.is_owner == false) && (("admin" in r.sub.env.user.roles) || ((r.sub.isInProject == true) && (r.sub.isInDepartment == true))))',

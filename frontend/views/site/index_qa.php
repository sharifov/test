            ...
            */?>
            ...
            <div class="animated flipInY col-md-3 col-sm-2 col-xs-12">
                <div class="tile-stats">
                    ...
                    <h3><?=Html::a('Calls', ['call/index'])?> (<?=number_format(\common\models\Call::find()->where('DATE(c_created_dt) = DATE(NOW())')->andWhere(['c_call_type_id' => \common\models\Call::CALL_TYPE_OUT])->sum('c_price'), 3)?> $) / In</h3>

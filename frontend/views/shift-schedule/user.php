...
$this->title = 'User Shift Schedule' . ' (' . $user->username . ')';
...
<div class="shift-schedule-index">
    ...
    <p>
        <?php
            /** @abac ShiftAbacObject::ACT_USER_SHIFT_SCHEDULE, ShiftAbacObject::ACTION_ACCESS, Access to actions shift-schedule/* */
        if (\Yii::$app->abac->can(null, ShiftAbacObject::ACT_USER_SHIFT_SCHEDULE, ShiftAbacObject::ACTION_ACCESS)) :
            ?>
            <?= Html::a(
                '<i class="fa fa-plus-circle"></i> Generate Example Data',
                ['generate-example', 'userId' => $user->id],
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-calendar"></i> User Calendar (TimeZone: <?= Html::encode($userTimeZone)?>)</h2>
        ...
        <div class="col-md-6">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-th"></i> User Assigned Shifts (TimeZone: <?php echo Yii::$app->formatter->timeZone?>)</h2>
                    <!--            <ul class="nav navbar-right panel_toolbox" style="min-width: initial;">-->
                    <!--                <li>-->
                    <!--                    <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>-->
                    <!--                </li>-->
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-bar-chart"></i> User Monthly scheduling statistics</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content" style="display: block">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-bars"></i> User TimeLine List (<?=Html::encode($searchModel->clientStartDate)?> -
...
$openModalEventUrl = \yii\helpers\Url::to(['shift-schedule/get-event', 'userId' => $user->id]);

...
/**
 * Class UserAccessAcceptTransfer
 ...
 */
class UserAccessAcceptTransfer implements UserAccessManageRequestInterface
{
    ...
    {
        if (!$this->actionPermission->canAcceptTransfer($this->chat)) {
            throw new \DomainException('Action is not allowed');
        }
        $this->accessService->acceptTransfer($this->chat, $this->access, $this->accessStatusId);
    }
}

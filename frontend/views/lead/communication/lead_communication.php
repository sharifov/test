...
//                                                    $typeList[$tk] = $itemName . ' (' . $agentParams->upp_tw_phone_number . ')';
                            ...
                            <div class="col-sm-3 form-group message-field-phone message-field-sms" id="phone-numbers-group" style="display: block;">
                                <?= $form->field($comForm, 'c_phone_number')->dropDownList($clientPhones, ['class' => 'form-control', 'id' => !SettingHelper::isLeadCommunicationNewCallWidgetEnabled() ? 'c_phone_number' : 'call-to-number']) ?>
                            </div>

...
//        }
        ...
        $menuCases[] = ['label' => 'Case Hot <span id="cases-q-hot" data-type="inbox" class="label-warning label pull-right cases-q-info"></span> ', 'url' => ['/cases-q/hot'], 'icon' => 'flag text-warning'];

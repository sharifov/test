...
class m210715_073110_add_abac_policy_for_sold_leads_query extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_object' => 'lead/lead/query/sold/projects',
            'ap_action' => '(access)',
            'ap_action_json' => "[\"access\"]",
            'ap_effect' => 1,
            'ap_title' => '',
        ...
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_object' => 'lead/lead/query/sold/departments',
            'ap_action' => '(access)',
            'ap_action_json' => "[\"access\"]",
            'ap_effect' => 1,
            'ap_title' => '',
        ...
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_subject' => '("admin" in r.sub.env.user.roles)',
            'ap_subject_json' => '{"condition":"AND","rules":[{"id":"env_user_roles","field":"env.user.roles","type":"string","input":"select","operator":"in_array","value":"admin"}],"valid":true}',
            'ap_object' => 'lead/lead/query/sold/groups',
            'ap_action' => '(access)',
            'ap_action_json' => "[\"access\"]",
            'ap_effect' => 1,
            'ap_title' => '',
    ...
    public function safeDown()
    {
        $this->delete('{{%abac_policy}}', ['IN', 'ap_object', [
            ...
            'lead/lead/query/sold/projects',
            'lead/lead/query/sold/departments',
            'lead/lead/query/sold/groups',

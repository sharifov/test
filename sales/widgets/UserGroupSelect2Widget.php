...
class UserGroupSelect2Widget extends Select2
{
    private const SELECTION_NAME = 'ug_name';
    private const SELECTION_ID = 'ug_id';
    ...
    public function init(): void
    {
        ...
        $this->url = $this->url ?: Url::to(['/user-group/list-ajax']);
...
JS;
        $this->getView()->registerJs($js, View::POS_HEAD, '/user-group/list-ajax');
    }

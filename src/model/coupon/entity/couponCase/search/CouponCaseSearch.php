...
namespace src\model\coupon\entity\couponCase\search;
...
class CouponCaseSearch extends CouponCase
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->cc_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'cc_created_dt', $this->cc_created_dt, $user->timezone);
        }

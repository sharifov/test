...
class FlightQuoteRepository
{
    ...
    public function find(?int $id): FlightQuote
    {
        ...
        throw new NotFoundException('Flight quote is not found', AttractionCodeException::FLIGHT_QUOTE_NOT_FOUND);
    }
    ...
    {
        if (!$quote->delete()) {
            throw new \RuntimeException('Removing error', AttractionCodeException::FLIGHT_QUOTE_REMOVE);
        }

...
namespace sales\model\leadRedial\entity\search;
...
class CallRedialUserAccessSearch extends CallRedialUserAccess
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->crua_created_dt) {
            \sales\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'crua_created_dt', $this->crua_created_dt, $user->timezone);
        }

        if ($this->crua_updated_dt) {
            \sales\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'crua_updated_dt', $this->crua_updated_dt, $user->timezone);
        }

...
namespace src\model\clientChat\entity\projectConfig\search;
...
/**
 * ClientChatProjectConfigSearch represents the model behind the search form of `src\model\clientChat\entity\projectConfig\ClientChatProjectConfig`.
 */

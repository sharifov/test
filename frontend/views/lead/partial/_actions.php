...
<?php $this->registerJsFile('/js/bootstrap-modal.min.js', ['depends' => [yii\web\JqueryAsset::className()]])?>
<?php $this->registerJsFile('/js/bootstrap-modalmanager.min.js', ['depends' => [yii\web\JqueryAsset::className()]])?>

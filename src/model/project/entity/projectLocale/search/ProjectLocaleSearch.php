...
namespace src\model\project\entity\projectLocale\search;
...
/**
 * ProjectLocaleSearch represents the model behind the search form of `src\model\project\entity\projectLocale\ProjectLocale`.
 */

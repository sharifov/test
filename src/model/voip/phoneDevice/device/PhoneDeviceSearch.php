...
class PhoneDeviceSearch extends PhoneDevice
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->pd_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'pd_created_dt', $this->pd_created_dt, $user->timezone);
        }

        if ($this->pd_updated_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'pd_updated_dt', $this->pd_updated_dt, $user->timezone);
        }

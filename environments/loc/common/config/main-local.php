...
return [
    ...
    'components' => [
        'db' => [
            ...
            'dsn' => 'mysql:host=' . env('common.config.main.components.db.dsn.host') . ';port=3306;dbname=' . env('common.config.main.components.db.dsn.dbname'),
            'username' => env('common.config.main.components.db.username'),
            'password' => env('common.config.main.components.db.password'),
            'charset' => 'utf8mb4',
            'enableSchemaCache' => env('common.config.main.components.db.enableSchemaCache'),
            'schemaCacheDuration' => env('common.config.main.components.db.schemaCacheDuration'),
        ],
        'db_postgres' => [
            'class' => 'yii\db\Connection',
            ...
            'charset' => 'utf8',
            'enableSchemaCache' => env('common.config.main.components.db_postgres.enableSchemaCache'),
            'schemaCacheDuration' => env('common.config.main.components.db_postgres.schemaCacheDuration'),
        ],
        'formatter' => [
        ...
        'redis' => [
            ...
            'database' => env('common.config.main.components.redis.database'),
        ...
        'cache' => [
            ...
            'redis' => [
                ...
                'database' => env('common.config.main.components.cache.redis.database'),
                'unixSocket' => null,
            ],
        ],
        'cacheFile' => [
        ...
        'prometheus' => [
            ...
            'redisOptions' => [
                ...
                'database' => env('common.config.main.components.prometheus.redisOptions.database'),
                'timeout' => 0.1,
                'read_timeout' => 10,
                'persistent_connections' => false,
            ],
            'useHttpBasicAuth' => env('common.config.main.components.prometheus.useHttpBasicAuth'),

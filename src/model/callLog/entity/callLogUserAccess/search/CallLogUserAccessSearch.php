...
namespace src\model\callLog\entity\callLogUserAccess\search;
...
class CallLogUserAccessSearch extends CallLogUserAccess
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->clua_access_start_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'clua_access_start_dt', $this->clua_access_start_dt, $user->timezone);
        }
        if ($this->clua_access_finish_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'clua_access_finish_dt', $this->clua_access_finish_dt, $user->timezone);
        }

...
namespace src\model\kpi\entity\kpiUserProductCommission\search;
...
/**
 * KpiUserProductCommissionSearch represents the model behind the search form of `src\model\kpi\entity\kpiUserProductCommission\KpiUserProductCommission`.
 */

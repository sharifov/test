...
namespace src\model\conference\entity\conferenceParticipantStats\search;
...
class ConferenceParticipantStatsSearch extends ConferenceParticipantStats
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->cps_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'cps_created_dt', $this->cps_created_dt, $user->timezone);
        }

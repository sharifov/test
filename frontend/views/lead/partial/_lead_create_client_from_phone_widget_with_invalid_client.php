...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <div id="create-lead-email">
            <?= $form->field($leadForm, 'email')->textInput([
                'type' => 'email'
            ])->label(true) ?>
        </div>
    </div>
...
JS;
        ...
        <div id="create-lead-phone">
            <?= $form->field($leadForm, 'phone')->widget(PhoneInput::class, [
                'jsOptions' => [
                    'nationalMode' => false,
...
<div class="row">
    <div class="col-md-4">
        <?= $form->field($leadForm, 'firstName')->textInput() ?>
    </div>

    <div class="col-md-4">
        <?= $form->field($leadForm, 'middleName')->textInput() ?>
    </div>

    <div class="col-md-4">
        <?= $form->field($leadForm, 'lastName')->textInput() ?>
    </div>
</div>
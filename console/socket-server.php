        ...
        if (isset($dataObj->act)) {
            switch ($dataObj->act) {
                case 'getUserConnections':
                    $dataResponse = ['command' => 'countUserConnection', 'cnt' => count($connectionsUser)];
                    break;
                case 'getLeadConnections':
                    $dataResponse = ['command' => 'countLeadConnection', 'cnt' => count($connectionsLead)];
                    break;
                case 'getCaseConnections':
                    $dataResponse = ['command' => 'countCaseConnection', 'cnt' => count($connectionsCase)];
                    break;
            }
        }
    }

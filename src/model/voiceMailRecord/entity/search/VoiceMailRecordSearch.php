...
namespace src\model\voiceMailRecord\entity\search;
...
class VoiceMailRecordSearch extends VoiceMailRecord
{
    ...
    public function search($params, Employee $user): ActiveDataProvider
    {
        ...
        if ($this->vmr_created_dt) {
            \src\helpers\query\QueryHelper::dayEqualByUserTZ($query, 'vmr_created_dt', $this->vmr_created_dt, $user->timezone);
        }

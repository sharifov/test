...
class CaseCommunicationForm extends Model
{
    ...
    public function rules() : array
    {
        return [
            ...
            [['c_email_to', 'c_language_id'], 'required', 'when' => function (CaseCommunicationForm $model) {
            ...
            [['c_email_message', 'c_email_subject'], 'required', 'when' => function (CaseCommunicationForm $model) {
            ...
            [['c_phone_number'], 'required', 'when' => function (CaseCommunicationForm $model) {
            ...
            /*[['c_sms_message'], 'required', 'when' => function (CaseCommunicationForm $model) {
            ...
            [['c_quotes'], 'required', 'when' => function (CaseCommunicationForm $model) {

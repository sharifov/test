...
namespace src\model\user\entity\payroll\search;
...
/**
 * UserPayrollSearch represents the model behind the search form of `src\model\user\entity\payroll\UserPayroll`.
 */

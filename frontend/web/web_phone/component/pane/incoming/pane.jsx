            ...
            <div className="actions-container">
                <div className="call-pane__call-btns">
                    ...
                    <button className="call-pane__start-call calling-state-block"
                            data-call-sid={call.data.callSid} onClick={() => PhoneWidgetCall.acceptInternalCall(call)}>
                    ...
                    <button className="call-pane__end-call"
                            data-call-sid={call.data.callSid} onClick={() => PhoneWidgetCall.rejectInternalCall(call)}>

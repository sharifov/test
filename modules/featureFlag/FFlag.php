...
class FFlag
{
    ...
    public const FF_KEY_LIST = [
        ...
        self::FF_KEY_SHIFT_SCHEDULE_REQUEST_SAVE_SEND_NOTIFICATION_BY_JOB_ENABLE => self::FF_KEY_SHIFT_SCHEDULE_REQUEST_SAVE_SEND_NOTIFICATION_BY_JOB_ENABLE,
        self::FF_KEY_FILTER_CONVERSION_DATE_AND_USER_IN_LEAD_SEARCH => self::FF_KEY_FILTER_CONVERSION_DATE_AND_USER_IN_LEAD_SEARCH,
    ];

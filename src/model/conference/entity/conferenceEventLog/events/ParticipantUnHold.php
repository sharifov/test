...
namespace src\model\conference\entity\conferenceEventLog\events;

use common\models\Conference;

class ParticipantUnHold implements Event
{
    public const NAME = Conference::EVENT_PARTICIPANT_UNHOLD;

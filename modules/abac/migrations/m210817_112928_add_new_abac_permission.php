...
/**
 * Class m210817_112928_add_new_abac_permission
 */
class m210817_112928_add_new_abac_permission extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_object' => 'case/case/act/reprotection_quote/original_quote_diff',
            'ap_action' => '(access)',
            'ap_action_json' => "[\"access\"]",
            'ap_effect' => 1,
            'ap_title' => 'View difference between original and reprotection quotes',
            'ap_sort_order' => 50,
            'ap_enabled' => 1,

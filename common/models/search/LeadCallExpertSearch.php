...
class LeadCallExpertSearch extends LeadCallExpert
{
    ...
    public function rules()
    {
        return [
            ...
            [['lce_request_text', 'lce_response_text', 'lce_response_lead_quotes', 'lce_expert_username'], 'safe'],
            [['lce_request_dt', 'lce_response_dt', 'lce_updated_dt' ], 'date', 'format' => 'php:Y-m-d'],
        ];
    }

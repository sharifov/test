...
namespace src\model\clientChat\componentEvent\form;

use src\forms\CompositeForm;
use src\model\clientChat\componentEvent\entity\ClientChatComponentEvent;
use common\components\validators\IsArrayValidator;
use src\model\clientChat\componentRule\form\ComponentRuleCreateForm;

/**
 * Class ComponentEventCreateForm
 * @package src\model\clientChat\componentEvent\form
 *

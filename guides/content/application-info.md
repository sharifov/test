...
|Nr.|Name|Type|Version|License|Source|Comments|
|---|---|---|---|---|---|---|
|1|Beanstalk|service|latest||||
|2|Redis|service|latest||||
|3|Geonames|service|latest||||
|4|CDN|service|latest||||
|5|Neutrino|service|latest||||
|6|Amazon S3|service|latest||||

# Application Dependencies
|Nr.|Name|Type|Version|License|Source|Authors|Comments|
|---|---|---|---|---|---|---|---|
|1|2amigos/2fa-library|library|2.0.2|BSD-3-Clause|https://github.com/2amigos/2fa-library.git|2amigOS! Consulting Group|2 Factor Authentication (2FA) library|
|2|2amigos/qrcode-library|library|2.0.0|BSD-3-Clause|https://github.com/2amigos/qrcode-library.git|2amigOS! Consulting Group|QrCode Generator|
|3|2amigos/yii2-arrayquery-component|yii2-extension|1.0.3|BSD-3-Clause|https://github.com/2amigos/yii2-arrayquery-component.git|2amigOS! Consulting Group|Yii2 component that allows for searching/filtering the elements of an array.|
|4|2amigos/yii2-ckeditor-widget|yii2-extension|2.2.0|BSD-3-Clause|https://github.com/2amigos/yii2-ckeditor-widget.git|2amigOS! Consulting Group|CKEditor widget for Yii2.|
|5|2amigos/yii2-date-picker-widget|yii2-extension|1.0.7|BSD-3-Clause|https://github.com/2amigos/yii2-date-picker-widget.git|2amigOS! Consulting Group|Bootstrap DatePicker widget for Yii2.|
|6|2amigos/yii2-date-time-picker-widget|yii2-extension|1.0.4|BSD-3-Clause|https://github.com/2amigos/yii2-date-time-picker-widget.git|2amigOS! Consulting Group|Bootstrap DateTimePicker widget for Yii2.|
|7|2amigos/yii2-multi-select-widget|yii2-extension|1.0.0|BSD-3-Clause|https://github.com/2amigos/yii2-multi-select-widget.git|2amigOS! Consulting Group|Multiselect Bootstrap widget for Yii2.|
|8|aki/yii2-bot-telegram|yii2-extension|3.1.5|LGPL-3.0+|https://github.com/akbarjoudi/yii2-bot-telegram.git|akbarjoudi|bot telegram|
|9|andrewblake1/yii2-credit-card|yii2-extension|dev-master|MIT|https://github.com/andrewblake1/yii2-credit-card.git|Andrew Blake, Yaroslav Havryliv|Yii2 credit card widget with client validation|
|10|apimatic/jsonmapper|library|v1.3.1|OSL-3.0|https://github.com/apimatic/jsonmapper.git|Christian Weiske, Mehdi Jaffery|Map nested JSON structures onto PHP classes|
|11|authorizenet/authorizenet|library|1.9.9|proprietary|https://github.com/AuthorizeNet/sdk-php.git||Official PHP SDK for Authorize.Net|
|12|aws/aws-crt-php|library|v1.0.2|Apache-2.0|https://github.com/awslabs/aws-crt-php.git|AWS SDK Common Runtime Team|AWS Common Runtime for PHP|
|13|aws/aws-sdk-php|library|3.209.27|Apache-2.0|https://github.com/aws/aws-sdk-php.git|Amazon Web Services|AWS SDK for PHP - Use Amazon Web Services in your PHP project|
|14|bacon/bacon-qr-code|library|1.0.3|BSD-2-Clause|https://github.com/Bacon/BaconQrCode.git|Ben Scholzen 'DASPRiD'|BaconQrCode is a QR code generator for PHP.|
|15|borales/yii2-phone-input|yii2-extension|0.3.0|BSD-3-Clause|https://github.com/Borales/yii2-phone-input.git|Borales (Alexandr Bordun)|Yii2 International telephone numbers - Asset Bundle, Behavior, Validator, Widget|
|16|bower-asset/bootstrap|bower-asset|v3.4.1|MIT|https://github.com/twbs/bootstrap.git|||
|17|bower-asset/bootstrap-datepicker|bower-asset|v1.7.0|Apache-2.0|git@github.com:eternicode/bootstrap-datepicker.git|||

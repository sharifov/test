...
class PhoneLineCrudController extends FController
{
    /**
    * @return array
    */
    ...
    public function actionCreate()
    {
        ...
        $model->line_created_user_id = Auth::id();
        $model->line_updated_user_id = Auth::id();
     ...
     * @throws NotFoundHttpException
     */
    protected function findModel($id): PhoneLine
    {

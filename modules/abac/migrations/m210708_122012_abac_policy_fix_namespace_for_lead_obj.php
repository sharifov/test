...
/**
 * Class m210708_122012_abac_policy_fix_namespace_for_lead_obj
 */
class m210708_122012_abac_policy_fix_namespace_for_lead_obj extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->insert('{{%abac_policy}}', [
            ...
            'ap_object' => 'lead/lead/ui/menu/client-info',
            'ap_action' => '(access)',
            'ap_action_json' => "[\"access\"]",
            'ap_effect' => 1,
    ...
    {
        $this->delete('{{%abac_policy}}', ['IN', 'ap_object', [
            'lead/lead/ui/block/client-info',

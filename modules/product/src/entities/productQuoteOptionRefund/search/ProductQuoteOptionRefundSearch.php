...
namespace modules\product\src\entities\productQuoteOptionRefund\search;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use modules\product\src\entities\productQuoteOptionRefund\ProductQuoteOptionRefund as ProductQuoteOptionRefundModel;
...
class ProductQuoteOptionRefundSearch extends ProductQuoteOptionRefundModel
{
    ...
    {
        $query = ProductQuoteOptionRefundModel::find();
        ...
        $query->andFilterWhere([
            ...
            'pqor_product_quote_option_id' => $this->pqor_product_quote_option_id,

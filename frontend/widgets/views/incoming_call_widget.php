...
<script>
    ...
    {
        // console.log(obj);
        $.pjax.reload({url: incomingCallUrl, container: '#incoming-call-pjax', push: false, replace: false, 'scrollTo': false, timeout: 5000, async: false}); // , data: {id: obj.id, status: obj.status}
    }
